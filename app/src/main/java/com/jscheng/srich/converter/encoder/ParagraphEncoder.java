...
public class ParagraphEncoder {
    ...
    private static void checkWordStyle(int wordStyle, int lastStyle, StringBuilder content) {
        ...
        checkWordStyle(wordStyle, lastStyle, Style.SubScriptSize, StyleCode.StrikethroughBegin, StyleCode.StrikethroughEnd, content);
        checkWordStyle(wordStyle, lastStyle, Style.SubScriptColor, StyleCode.StrikethroughBegin, StyleCode.StrikethroughEnd, content);
    }
