...
public class ParagraphDecoder {
    ...
    private static void decodeWordStyle(ParagraphBuilder builder, String content) {
        ...
        childs = node.splitStyle(childs, StyleCode.UnderLineBegin, StyleCode.UnderLineEnd, Style.SubScriptSize);
        childs = node.splitStyle(childs, StyleCode.UnderLineBegin, StyleCode.UnderLineEnd, Style.SubScriptColor);
