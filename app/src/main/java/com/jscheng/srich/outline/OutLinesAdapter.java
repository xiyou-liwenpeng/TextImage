...
import com.liwenpeng.textimage.view.main.module.main.IShowLongView;
...
public class OutLinesAdapter extends RecyclerView.Adapter {
    ...
    private IShowLongView mIShowLongView;
    ...
    public OutLinesAdapter(Context context, View parentView, LinearLayoutManager layoutManager, IShowLongView iShowLongView) {
        mParentView = parentView;
        mContext = context;
        mLayoutInfater = LayoutInflater.from(mContext);
        mLayoutManager = layoutManager;
    ...
    private void bindNoteViewHolder(ItemNoteViewHolder noteViewHolder, final OutLine outline) {
        ...
        noteViewHolder.contentLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mPresenter == null){
                    Router.with(mContext).route("editnote").intent("id", outline.getNote().getId()).go();
                }else {
        ...
        noteViewHolder.contentLayout.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                }else if (mIShowLongView != null){
                    mIShowLongView.showCenterDialog(outline.getNote().getId());
                }
                return false;
            }
        });
