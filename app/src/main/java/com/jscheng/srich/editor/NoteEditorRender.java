...
import com.jscheng.srich.editor.render.word_render.NoteItalicSpanColor;
...
import com.jscheng.srich.editor.render.word_render.NoteItalicSpanSize;
...
public class NoteEditorRender {
    ...
    public NoteEditorRender(EditText editText) {
        ...
        mWordSpanRenderList.add(new NoteItalicSpanSize());
        mWordSpanRenderList.add(new NoteItalicSpanColor());
