...
public class NoteEditorManager implements INoteEditorManager{
    ...
    @Override
    public void commandSize(boolean isSelected, boolean draw) {
        mManagerImpl.inputSize(isSelected, draw);
    }

    @Override
    public void commandSubColor(boolean isSelected, boolean draw) {
        mManagerImpl.inputColors(isSelected, draw);
    }
