...
public class NoteEditorBar extends FrameLayout implements ViewTreeObserver.OnGlobalLayoutListener,
    ...
    private TextView mSubSize;
    private TextView mSubColor;
    ...
    private void initView() {
        ...
        mSubColor = findViewById(R.id.edit_bar_yanse);
        mSubColor.setOnClickListener(this);

        mSubSize = findViewById(R.id.edit_bar_size);
        mSubSize.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.edit_bar_strikethrough:
                tapbarStrikeThrough();
                break;
            case R.id.edit_bar_size:
                tapBarSize();
                break;
            case R.id.edit_bar_yanse:
                tapBarColorBu();
                break;
            default:
                break;
    ...
    private void tapBarSize() {
        boolean isSelected = !mSubSize.isSelected();
        mSubSize.setSelected(isSelected);
        mStyleManager.commandSize(isSelected,true);
    }

    private void tapBarColorBu() {
        boolean isSelected = !mSubColor.isSelected();
        mSubColor.setSelected(isSelected);
        mStyleManager.commandSubColor(isSelected,true);
    }
