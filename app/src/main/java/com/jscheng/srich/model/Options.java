...
public class Options {
    ...
    public boolean isSize() {
        return Style.isWordStyle(wordStyle, Style.SubScriptSize);
    }

    public void setSize(boolean underline) {
        wordStyle = Style.setWordStyle(wordStyle, underline, Style.SubScriptSize);
    }
    public boolean isColors() {
        return Style.isWordStyle(wordStyle, Style.SubScriptColor);
    }

    public void setColors(boolean underline) {
        wordStyle = Style.setWordStyle(wordStyle, underline, Style.SubScriptColor);
    }
    ...
    public static Options getSameStyle(boolean isCanRecover, boolean isCanRetroke,
        ...
        for (int word: wordStyles) {
            ...
            if (!Style.isWordStyle(word, Style.SubScriptColor)) {
                options.setSubScript(false);
            }if (!Style.isWordStyle(word, Style.SubScriptSize)) {
                options.setSubScript(false);
            }
        }
        return options;
