...
public class IMGEditActivity extends IMGEditBaseActivity {
    ...
    public static final String EXTRA_IMAGE_Bitmap = "Bitmap";

    public static final String EXTRA_IMAGE_SAVE_PATH = "IMAGE_SAVE_PATH";

    private static Bitmap mBitmap;

    private static UpdateBitmap updateBitmaps;

    public static void setBitmap (Bitmap bitmap, UpdateBitmap updateBitmap){
        mBitmap = bitmap;
        updateBitmaps = updateBitmap;
    }
...
//        return bitmap;
    ...
    public void onDoneClick() {
        ...
        if (updateBitmaps != null) {
            updateBitmaps.setImage(bitmap);
        }
